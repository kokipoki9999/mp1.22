          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group cursor-pointer flex flex-col items-center text-center sm:items-start sm:text-left">
                <div className="aspect-[4/5] bg-white overflow-hidden mb-3">
                  <img
                    src="/bathroom-modern-wood-tray copy.png"
                    alt="Bathroom Tray"
                    className="w-full h-full object-contain"
                  />
                </div>
                ...
                <a
                  href="https://www.amazon.com/Bathroom-Organizer-Decorative-Rectangular-Cosmetic/dp/B0BF3WT9HX?ie=UTF8&th=1&linkCode=ll2&tag=maisonpacem05-20&linkId=0bcf2d50cbc50f6100c15963defed053&language=en_US&gaOptInStatus=true&ref_=as_li_ss_tl"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-flex items-center gap-1.5 text-[10px] text-gray-600 underline underline-offset-2 transition-colors hover:text-gray-500"
                >
